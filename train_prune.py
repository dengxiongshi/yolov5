...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5s-pruning.yaml', help='model.yaml path')
    ...
    parser.add_argument('--patience', type=int, default=200, help='EarlyStopping patience (epochs without improvement), 0 is disable EarlyStopping')
