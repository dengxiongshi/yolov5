...
if __name__ == "__main__":
    picPath = r"E:\downloads\compress\datasets\yolo_wider\val\images"  # 图片所在文件夹路径，后面的/一定要带上
    txtPath = r"E:\downloads\compress\datasets\yolo_wider\val\labels_final"  # txt所在文件夹路径，后面的/一定要带上
    xmlPath = r"E:\downloads\compress\datasets\yolo_wider\val\labels_final_Annotations"  # xml文件保存路径，后面的/一定要带上
